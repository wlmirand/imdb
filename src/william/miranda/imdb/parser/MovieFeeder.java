 ...
 * para o parser. Para obter a URL, este parser precisa do ano e do t�tulo do filme.
 * O retorno � uma Lista contendo todas as URLs.
 * @author William
 *
 */
public class MovieFeeder
{
	 ...
	 * Entao, fazemos um GET e analisamos o html que é retornado
